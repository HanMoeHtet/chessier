...
const PrivacyPolicies: React.FC = () => {
  return (
    <div className="policies relative bg-gray-700 text-gray-200">
      ...
      <div className="container mx-auto py-10">
        ...
        <p>Chessier uses the collected data for various purposes:</p>
        ...
        <p>
          If you are located outside Myanmar (Burma) and choose to provide
          information to us, please note that we transfer the data, including
          Personal Data, to Myanmar (Burma) and process it there.
        </p>
        <p>
        ...
        <p>
          Chessier will take all the steps reasonably necessary to ensure that
        ...
        <p>
          ...
          us at <b>hanmoehtet.dev@gmail.com</b>.
        </p>
        ...
        <p>
          ...
          by email: <b>hanmoehtet.dev@gmail.com</b>.
        </p>
